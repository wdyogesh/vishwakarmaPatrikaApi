            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-validation">
                        <form action="{{URL::to('admin/our-team/update-'.$teamdata->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="title" value="{{$teamdata->title}}" placeholder="{{trans('labels.title')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="subtitle" value="{{$teamdata->subtitle}}" placeholder="{{trans('labels.subtitle')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="fb" value="{{$teamdata->fb}}" placeholder="{{trans('labels.facebook_link')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="youtube" value="{{$teamdata->youtube}}" placeholder="{{trans('labels.youtube_link')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="insta" value="{{$teamdata->insta}}" placeholder="{{trans('labels.instagram_link')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <img src="{{Helper::image_path($teamdata->image)}}" alt="" class="img-fluid rounded hw-50 mt-1">
                                </div>
                            </div>
                            <div class="form-group row">
