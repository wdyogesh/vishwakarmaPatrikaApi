...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">{{trans('labels.add_addons')}}</a></li>
        </ol>
    </div>
</div>
<!-- row -->
                    ...
                    <div class="form-validation">
                        <form action="{{URL::to('admin/addons/store')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <label class="radio-inline mr-3"><input type="radio" name="type" value="1" onclick="get_price(this)"  {{old('type')==1 ? 'checked' : ''}}> {{trans('labels.free')}}</label>
                                    <label class="radio-inline mr-3"><input type="radio" name="type" value="2" onclick="get_price(this)"  {{old('type')==2 ? 'checked' : ''}}> {{trans('labels.paid')}}</label>
                                    @error('type') <br><span class="text-danger">{{$message}}</span> @enderror
                                </div>
                            </div>
                            <div class="form-group row dn @if(old('type')==2) d-flex @endif" id="price_row">
