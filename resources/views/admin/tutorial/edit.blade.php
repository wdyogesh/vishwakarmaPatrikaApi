...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{URL::to('admin/blog')}}">{{trans('labels.tutorial')}}</a></li>
                ...
                <div class="card-body">
                    <div class="form-validation">
                        <form action="{{URL::to('admin/tutorial/update-'.$tutorialdata->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 text-md-right text-sm-left col-form-label" for="">{{trans('labels.image')}} (400x400) <span class="text-danger">*</span></label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-8 m-auto">
                                    ...
                                    <a href="{{URL::to('admin/tutorial')}}" class="btn btn-dark">{{trans('labels.cancel')}}</a>
                                </div>
                            </div>
                        </form>
                    </div>
