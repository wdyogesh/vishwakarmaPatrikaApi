    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card" style="height: 450px">
                <div class="card-body">
                    <div class="card-header"><h3 class="card-title">{{trans('labels.add_new')}}</h3></div>
                    <div class="form-validation">
                        <form action="{{URL::to('admin/zone/store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="col-lg-12 col-form-label" for="">{{trans('labels.name')}} <span class="text-danger">*</span></label>
                                <div class="col-lg-12">
                                    <input type="text" class="form-control" name="name" placeholder="{{trans('labels.name')}}" required>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{@Helper::appdata()->map}}&libraries=drawing,places"></script>
    <script type="text/javascript">
        ...
        function initialize() {
            var myLatlng = {lat: {{@Helper::appdata()->lat}},lng: {{@Helper::appdata()->lang}}};
            var myOptions = {
                zoom: 13,
                center: myLatlng,
