...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">{{trans('labels.add_slider')}}</a></li>
        </ol>
    </div>
</div>
<!-- row -->
                    ...
                    <div class="form-validation">
                        <form action="{{URL::to('admin/slider/store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select name="type" class="form-control type" data-live-search="true" id="type">
                                        ...
                                        <option value="1">{{trans('labels.category')}}</option>
                                        <option value="2">{{trans('labels.item')}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea name="description" class="form-control" rows="4" placeholder="{{trans('labels.description')}}">{{old('description')}}</textarea>
