                        ...
                        <form action="{{URL::to('admin/promocode/store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="offer_name" value="{{old('offer_name')}}" id="offer_name" placeholder="{{trans('labels.offer_name')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="offer_code" value="{{old('offer_code')}}" id="offer_code" placeholder="{{trans('labels.offer_code')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="offer_type" class="form-control">
                                                ...
                                                <option value="1" {{old('offer_type') == "1" ? 'selected' : ''}}>{{trans('labels.fixed')}}</option>

                                                <option value="2" {{old('offer_type') == "2" ? 'selected' : ''}}>{{trans('labels.percentage')}}</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="usage_type" class="form-control">
                                                ...
                                                <option value="1" {{old('usage_type') == "1" ? 'selected' : ''}}>{{trans('labels.once_time')}}</option>

                                                <option value="2" {{old('usage_type') == "2" ? 'selected' : ''}}>{{trans('labels.multiple_times')}}</option>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="expire_date" value="{{old('expire_date')}}" id="expire_date">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="offer_amount" value="{{old('offer_amount')}}" id="price" placeholder="{{trans('labels.amount')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="min_amount" value="{{old('min_amount')}}" id="min_amount" placeholder="{{trans('labels.min_amount')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <textarea class="form-control" name="description" rows="3" id="description" placeholder="{{trans('labels.description')}}">{{old('description')}}</textarea>
