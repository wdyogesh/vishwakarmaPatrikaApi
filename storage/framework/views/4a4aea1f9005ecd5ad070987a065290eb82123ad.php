...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)"><?php echo e(trans('labels.add_banner')); ?></a></li>
        </ol>
    </div>
</div>
<?php
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-8 m-auto">
                                    ...
                                    <a class="btn btn-dark" <?php if($section == 0): ?> href="<?php echo e(URL::to('admin/banner')); ?>" <?php else: ?> href="<?php echo e(URL::to('admin/bannersection-'.$section)); ?>" <?php endif; ?>><?php echo e(trans('labels.cancel')); ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpg1lamw0vps/public_html/ecom/mywinkel.in/admin/resources/views/admin/banner/add.blade.php ENDPATH**/ ?>