...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)"><?php echo e(trans('labels.send_notification')); ?></a></li>
        </ol>
    </div>
</div>
<!-- row -->
                    ...
                    <div class="form-validation">
                        <form action="<?php echo e(URL::to('admin/notification/store')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="title" placeholder="<?php echo e(trans('labels.title')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 text-md-right text-sm-left col-form-label" for=""><?php echo e(trans('labels.message')); ?> <span class="text-danger">*</span></label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="message" placeholder="<?php echo e(trans('labels.message')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row 1 gravity <?php if(old('type') == 1): ?> <?php else: ?> dn <?php endif; ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row 2 gravity <?php if(old('type') == 2): ?> <?php else: ?> dn <?php endif; ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-8 m-auto">
                                    ...
                                    <a href="<?php echo e(URL::to('admin/notification')); ?>" class="btn btn-dark"><?php echo e(trans('labels.cancel')); ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script src="<?php echo e(url('resources/views/admin/notification/notification.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mpg1lamw0vps/public_html/ecom/mywinkel.in/admin/resources/views/admin/notification/add.blade.php ENDPATH**/ ?>