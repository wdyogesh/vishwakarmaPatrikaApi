...
unset($__errorArgs, $__bag); ?>   
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 text-md-right text-sm-left col-form-label" for="password"><?php echo e(trans('labels.password')); ?></label>
                                <div class="col-lg-6">
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\mywinkel\resources\views/admin/employee/add.blade.php ENDPATH**/ ?>